		...
		<form id="search" action="${ pageContext.request.contextPath }/ListFileServlet" method="get" >
			<div class="input-box"  >
				<input id="files-info" name="kw" type="text"
					...
					placeholder="Search File" style=" background: rgb(192, 190, 130); color: white;" />
					<span	class="iconfont search-text-icon" style="color: rgb(50, 121, 175);">&#xe714;</span>
			</div>
		</form>
	</div>
	...
	<div class="list">
		<c:choose>
			...
			<c:otherwise>
				...
				<c:if test="${ param.page < 0 }">
					<%
						request.getRequestDispatcher("/FileSmartHadoop/home-smart.jsp?page=1");
					%>
				</c:if>
				...
				<c:if test="${ param.page > requestScope.maxPage}">
					<%
						request.getRequestDispatcher(
											"/FileSmartHadoop/home-smart.jsp?page=" + request.getAttribute("maxpage"));
					%>
				</c:if>
			</c:otherwise>
		...
		<div class="file-list">
			...
			<div class="pages">
				...
				&nbsp; <a
					href="http://localhost:8080/FileSmartHadoop/home-smart.jsp?page=1&kw="
					id="firstPage">首页</a> &nbsp; <a
					href="http://localhost:8080/FileSmartHadoop/home-smart.jsp?page=${ requestScope.page-1 }&kw=${ param.kw }"
					id="lastPage">上一页</a> &nbsp; <a
					href="http://localhost:8080/FileSmartHadoop/home-smart.jsp?page=${ requestScope.page+1 }&kw=${ param.kw }"
					id="nextPage">下一页</a> &nbsp; <a
					href="http://localhost:8080/FileSmartHadoop/home-smart.jsp?page=${ requestScope.maxPage }&kw=${ param.kw }"
					id="endPage">尾页</a>
			</div>
		</div>
